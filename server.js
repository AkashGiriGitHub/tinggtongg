...
router.post('/getOrder', (req, res) => { //Line 9
  ...
  connection.query("INSERT into order_master SET service_type='Laptop Repair',service_desc='Laptop Repair',time_slot='09-07-2021',cust_name='Akash_09_07_2021',cust_phone_no='8378809034',cust_address='Navi Mumbai',cust_city='Mumbai',email='akkiproid@gmail.com',cust_area='Dombivili',reject_reason='No',order_date='09-07-2021', service_date='09-07-2021', userid='9975212', coupon_code='abcd',assigned_to='unassigned', status='unassigned'", function (err, results) {
    if (err) throw err
